...
internal sealed record LauncherStrings(
    ...
    string ValidatingClientManifest,
    string ClientUpToDate,
    string BackingUpFiles,
    string InstallingFile,
    string CheckingFile,
    string DownloadingClient,
    string ClientInstalled,
...
internal static class LauncherLocalization
{
    ...
    private static readonly LauncherStrings Spanish = new(
        ...
        "MODERN INTERLUDE", "x15 / CONTENIDO CUSTOM / EXPERIENCIA CLASICA", "OPCIONES",
        ...
        "Validando manifiesto del cliente...", "Cliente {0} actualizado.",
        "Respaldando archivos que van a cambiar...", "Instalando {0}", "Verificando {0}",
    ...
    private static readonly LauncherStrings English = new(
        ...
        "MODERN INTERLUDE", "x15 / CUSTOM CONTENT / CLASSIC EXPERIENCE", "OPTIONS",
        ...
        "Validating client manifest...", "Client {0} is up to date.",
        "Backing up files that will change...", "Installing {0}", "Checking {0}",
    ...
    private static readonly LauncherStrings Portuguese = new(
        ...
        "MODERN INTERLUDE", "x15 / CONTEUDO CUSTOM / EXPERIENCIA CLASSICA", "OPCOES",
        ...
        "Validando manifesto do cliente...", "Cliente {0} atualizado.",
        "Salvando backup dos arquivos que serao alterados...", "Instalando {0}", "Verificando {0}",
